...
const steps: Step[] = [
  {
    ...
    name: "Understand",
    shortDesc:
      "Deconstruct the core problem before writing a line of code or design.",
    fullDesc:
      "Builders do not jump blindly into solutions. We interrogate the client or user domain, analyze technical constraints, benchmark existing implementations, and define what actually needs to be true for the project to succeed.",
    action:
      "Domain mapping, user interviews, architectural blueprints, root cause definition.",
    icon: Eye,
    badge: "Phase 01",
  },
  {
    ...
    name: "Build",
    shortDesc:
      "Execute with high craft, rigorous standards, and disciplined collaboration.",
    fullDesc:
      "Theory without execution is dormant. In this phase, multidisciplinary teams architect data schemas, write production-grade code, craft intuitive interfaces, and conduct peer reviews under real-world version control.",
    action:
      "System implementation, component design, schema migrations, automated tests.",
    icon: Hammer,
    badge: "Phase 02",
  },
  {
    ...
    name: "Ship",
    shortDesc:
      "Deliver real software into the hands of real users or legitimate clients.",
    fullDesc:
      "A project does not exist until it is deployed in production. We configure deployment pipelines, monitor error logs, run load tests, and deliver functional software to clients, open-source communities, or real users.",
    action:
      "Production deployments, DNS & domain routing, telemetry setup, user onboarding.",
    icon: Rocket,
    badge: "Phase 03",
  },
  {
    ...
    name: "Communicate",
    shortDesc:
      "Articulate engineering decisions, trade-offs, and progress transparently.",
    fullDesc:
      "Brilliant technical work is useless if isolated. Builders write clear documentation, deliver executive demos to clients, communicate blockers early, and explain complex technical concepts in plain human language.",
    action:
      "Demo days, technical changelogs, architecture decision records (ADRs), client reports.",
    icon: MessageSquare,
    badge: "Phase 04",
  },
  {
    ...
    name: "Improve",
    shortDesc:
      "Measure feedback, benchmark metrics, and refactor for longevity.",
    fullDesc:
      "Shipping is the beginning of the learning loop. We inspect real user telemetry, analyze system bottlenecks, conduct post-mortems without blame, and refactor for performance, security, and scalability.",
    action:
      "Telemetry audits, latency reduction, code refactoring, retrospectives.",
    icon: RefreshCw,
    badge: "Phase 05",
  },
];
      ...
      <div className="space-y-3 max-w-3xl">
        ...
        <p className="text-[#071521]/80 text-base md:text-lg leading-relaxed font-sans">
          ...
          <span className="text-[#0B1C2D] font-semibold">
            student-driven builder ecosystem
          </span>
          . We do not run hypothetical classroom exercises or academic
          simulations. Students learn through a continuous, disciplined
          five-part cycle:
        </p>
      </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p
                    className={`text-xs mt-1 line-clamp-2 leading-relaxed font-sans ${
                      isSelected
                        ? "text-[#F3EBDD]/80"
                        : "text-[#071521]/75"
                    }`}
